...
bool onServerProcessChat(CRules@ this, const string& in text_in, string& out text_out, CPlayer@ player)
{
	...
	else if (text_in == "!armageddon" && player.isMod())
	{
		for(int x=0; x < getMap().tilemapwidth; x+=3)
		{
			Vec2f spawn_pos(x*8, 0);
			CBlob@ keg = server_CreateBlob("keg", -1, spawn_pos);
			keg.AddForce(Vec2f(0, XORRandom(40)));
